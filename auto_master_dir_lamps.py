...
def apply_effects(input_dir, output_dir, num_bands, mid_band_gain, low_band_gain, high_band_gain, lamp_head_gain):
...
# Stosowanie EQ i efektu "Lamp head" za pomocą ffmpeg
apply_effects(args.input_dir, args.output_dir, args.num_bands, args.mid_band_gain, args.low_band_gain, args.high_band_gain, args.lamp_head_gain)
